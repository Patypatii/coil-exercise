...
def load_sales():
    ...
    quantity = raw_data[:, 0].astype(int)
...
def load_wine():
    data = np.genfromtxt('files/wine.csv', delimiter=',', dtype=float)
    return data
